            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
                        ...
                        <!-- Letter "M" -->
                        <text x="15" y="40" font-family="Arial" font-size="40" fill="white">M</text>
                      
                        <!-- Letter "A" -->
                        <text x="35" y="65" font-family="Arial" font-size="40" fill="white">A</text>
                      
                        <!-- Letter "X" -->
                        <text x="55" y="40" font-family="Arial" font-size="40" fill="white">X</text>
                      
                        <!-- Letter "A" -->
                        <text x="75" y="65" font-family="Arial" font-size="40" fill="white">A</text>
                      </svg>
                </div>

                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <a href="{{ route('payments') }}" class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Pay Now</h2>
